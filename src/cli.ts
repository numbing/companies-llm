...
import { coercePositiveInteger } from "./utils";
...
Options:
  ...
  --model, -m            Model to use for evaluation (default: ${DEFAULT_MODEL})
...
export function parseArgs(argv: string[]): CliOptions {
  ...
  const defaultConcurrency = coercePositiveInteger(
    process.env.STARTUP_SCOUT_MAX_CONCURRENCY,
